...
public final class UIAnimation extends UIIcon {
    ...
    protected BufferedImage getImageToPaint() {
        BufferedImage fullImage = resizableImage.getContent(rect.getWidth(), rect.getHeight());
    ...
    // TODO: add a way to 'freeze' (stop) the animations.
