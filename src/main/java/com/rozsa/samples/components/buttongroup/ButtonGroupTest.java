package com.rozsa.samples.components.buttongroup;
...
public class ButtonGroupTest {
    ...
    public void run() throws IOException {
        ScreenHandler<ScreenType> screen = TestUtils.createDefaultScreenHandler("Button Group test", false);
    ...
    public ViewTemplate getTemplate() throws IOException {
        JsonReader<ViewTemplate> reader = new JsonReader<>("/templates/button_group_test.json", ViewTemplate.class);
        return reader.read();
    }
}
