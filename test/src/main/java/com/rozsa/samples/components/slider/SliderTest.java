package com.rozsa.samples.components.slider;
...
public class SliderTest {
    public void run() throws IOException {
        ScreenHandler<ScreenType> screen = TestUtils.createDefaultScreenHandler("Slider test", false);
    ...
    public ViewTemplate getTemplate() throws IOException {
        JsonReader<ViewTemplate> reader = new JsonReader<>("/templates/slider_test.json", ViewTemplate.class);
        return reader.read();
    }
}
